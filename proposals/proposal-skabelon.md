...
_{Kort, fængende undertitel der forklarer hvad forslaget handler om}_

<p style="text-align:right"><small><a href="mailto:jan.maack@os2.eu">Jan Maack Kjerbye - Enterprise Arkitekt @ os2.eu ✉️</a></small></p>

<br>

> _Som [målgruppe] kan du stå i en situation hvor [problem]. Men det behøver ikke være sådan!_
>
> _[Forslagets løsning] gør [effekt] - fra den første idé til den endelige [resultat]. Modellen bygger på [grundlag]._
...
| **Handlefrihed til [målgruppe]** |
| [Beskrivelse af fordel 2] |

| **Digital suverænitet** |
| [Beskrivelse af fordel 3 - f.eks. om kontrol over egne løsninger] |

| **Direkte genbrugelighed** |
| [Beskrivelse af fordel 4 - f.eks. om at andre kan genbruge løsningen] |
...
[Når I arbejder åbent og transparent, kan I opbygge et fællesskab omkring jeres løsning. Beskriv de fremadrettede muligheder.]
